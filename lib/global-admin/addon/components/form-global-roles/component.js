...
const LOGIN_ACCESS_ROLES = [
  ...
  {
    name:                      FIBODT,
    translationKey:            'formGlobalRoles.mode.fibodt.label',
    descriptionTranslationKey: 'formGlobalRoles.mode.fibodt.detail',
  },
];
...
export default Component.extend({
  ...
  initRoles() {
    ...
    const baseRoles                                            = [ADMIN, USER, FIBODT, BASE].map((r) => allRoles.findBy('id', r));
